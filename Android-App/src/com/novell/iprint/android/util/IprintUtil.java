...
public class IprintUtil extends IPrintAndroidInit{
	...
	public static void gotoPrinters() throws Exception {
		
		//Click on Menu -> Printers
		if(androidAutomationUtility.isDisplayed(driver, HamburgerMenuItemsLocator.sButton_Printers)) {
			androidAutomationUtility.click(driver, HamburgerMenuItemsLocator.sButton_Printers);
		}else
		androidAutomationUtility.click(driver, HamburgerMenuItemsLocator.sMenuIcon);
		
		androidAutomationUtility.click(driver, HamburgerMenuItemsLocator.sButton_Printers);
		
//		androidAutomationUtility.wait_and_clickMobileELement(driver, HamburgerMenuItemsLocator.sMenuIcon, timeOutInSeconds);
//		androidAutomationUtility.wait_and_clickMobileELement(driver, HamburgerMenuItemsLocator.sButton_Printers, timeOutInSeconds);
	}
	
	public void gotoAppSettings() throws Exception 
	{
		//Click on Menu -> Settings
		if(androidAutomationUtility.isDisplayed(driver, HamburgerMenuItemsLocator.sButton_Settings)) {
			androidAutomationUtility.click(driver, HamburgerMenuItemsLocator.sButton_Settings);
		}else
		androidAutomationUtility.click(driver, HamburgerMenuItemsLocator.sMenuIcon);
...
//		androidAutomationUtility.wait_and_clickMobileELement(driver, HamburgerMenuItemsLocator.sMenuIcon, timeOutInSeconds);
//		androidAutomationUtility.wait_and_clickMobileELement(driver, HamburgerMenuItemsLocator.sButton_Settings, timeOutInSeconds);
	...
	public void gotoWalkUpJobs() throws Exception {
		...
		{
			androidAutomationUtility.click(driver, HamburgerMenuItemsLocator.sMenuIcon);
			androidAutomationUtility.wait_and_clickMobileELement(driver, HamburgerMenuItemsLocator.sButton_WalkupJobs, 5);
		}
...
//			if(androidAutomationUtility.isElementPresent(driver, HamburgerMenuItemsLocator.sButton_JobHistory)) 
//			{
//				androidAutomationUtility.click(driver, HamburgerMenuItemsLocator.sButton_JobHistory);
//			}
//			else {
//				androidAutomationUtility.click(driver, HamburgerMenuItemsLocator.sMenuIcon);
//				androidAutomationUtility.click(driver, HamburgerMenuItemsLocator.sButton_JobHistory);
...
//		}
	...
	public static void addServer(AndroidDriver<AndroidElement>  driver,String sIP) throws Exception
	{
		...
		}else if(androidAutomationUtility.isDisplayed(driver, SettingsPageLocator.settingAddServer))
		{
			androidAutomationUtility.click(driver, SettingsPageLocator.settingAddServer);
		}
