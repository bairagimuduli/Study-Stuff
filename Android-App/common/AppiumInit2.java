 ...
 *
 */
public final class AppiumInit2 {

	private static String appiumPath;
	public static volatile boolean isServerStopped = true;

	private static AppiumInit2 appiumInit2 = new AppiumInit2();
	private AppiumInit2() {	
	...
	public static AppiumInit2 getInstance() throws FileNotFoundException{
...
//		sCommand = sCommand.concat(" " + "127.0.0.1");
//		sCommand = sCommand.concat(" " + "--port");
//		sCommand = sCommand.concat(" " + "4723");
//		sCommand = sCommand.concat(" " + "--log-level");
//		sCommand = sCommand.concat(" " + "debug");
		...
		Thread startServerThread = new Thread()
		{
			...
			{
				try {
//					String start_server = "node /usr/local/lib/node_modules/appium/build/lib/main.js";
					
					String start_server = "cmd /c appium";
	...
	public void stopAppiumServer() {
		...
		if (osName.toLowerCase().contains("windows")){
			...
			killCmd = "taskkill /f /im node.exe";
